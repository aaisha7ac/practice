...
Start server (Using Python's built-in server to avoid CORS issues):
...
Comprehensive Unit Testing: Built a robust TestCase suite validating 13 distinct scenarios, ensuring the scoring algorithm handles edge cases like past-due dates, missing fields, and complex dependency chains correctly.
